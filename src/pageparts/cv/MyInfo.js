...
const MyInfo = (tCV) => {
    ...
    const intro = <span className="text-center">
        ...
        <span className="newline"><span className="text-center nolineP littlespace"><p><i className="las la-map-marker la-lg mr-2"></i></p><p>Remote work / Cali, Colombia</p></span></span>
